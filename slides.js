 ...
 *  Co-Coded with: Claude AI, and Sonnet 4.5
 */
(function () {
    // Inject CSS
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    section:nth-child(even) { background: #252d3d; color: #eee; }
  ...
  `;
    ...
    // Load plantuml.js
    const meScript = document.createElement('script');
    meScript.src = 'https://cdn.jsdelivr.net/npm/mermaid/dist/mermaid.min.js';
    meScript.onload = function () {
        mermaid.initialize({
            ...
            themeVariables: {
                ...
                primaryBorderColor: '#404060',
                lineColor: '#606080',
                secondBkgColor: '#252d3d',
                tertiaryColor: '#404060',
